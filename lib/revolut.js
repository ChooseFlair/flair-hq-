...
const REVOLUT_CLIENT_ID = process.env.REVOLUT_CLIENT_ID || 'lvD5cK32DGqKdXVdOnFA04W_5tcwRiZBsQVVQ2jRRPI'
const REVOLUT_REDIRECT_URI = process.env.REVOLUT_REDIRECT_URI || 'https://flair-hq-3ekh.vercel.app/api/revolut/callback'
