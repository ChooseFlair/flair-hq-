...
export const DEFAULT_PLANNED_BILLS = [
  { name: 'Mortgage', category: 'Home' },
  { name: 'Council Tax', category: 'Home' },
  { name: 'Water', category: 'Home' },
  { name: 'Electric & Gas', category: 'Home' },
  { name: 'House Insurance', category: 'Home' },
  { name: 'Food Shop', category: 'Food' },
  { name: 'Dog Food', category: 'Pets' },
  { name: 'Cat Food', category: 'Pets' },
  { name: "Bella's Insurance", category: 'Pets' },
  { name: 'Tesla', category: 'Transport' },
  { name: 'Hyundai', category: 'Transport' },
  { name: 'BRSK', category: 'Tech & Subs' },
  { name: 'Joint EE', category: 'Tech & Subs' },
  { name: 'Prime', category: 'Tech & Subs' },
  { name: 'Gym', category: 'Lifestyle' },
  { name: 'Buffer & Entertainment', category: 'Lifestyle' },
  { name: 'Retainers', category: 'Work' },
