      ...
      <div className="relative z-20 px-4 pt-2 pb-5 border-t border-cyan-500/10 flex flex-col items-center gap-3">
        <div className="flex items-center justify-center gap-6">
          <button
            onClick={() => setPromptsOpen(true)}
            title="Quick prompts"
            className="w-11 h-11 rounded-full bg-white/[0.06] border border-white/10 text-white hover:bg-white/[0.10] hover:border-white/20 flex items-center justify-center pill-hover"
          >
