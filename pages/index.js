      ...
      <div className="h-screen flex flex-col bg-gray-50">
        ...
        <header className="px-6 py-3 bg-white border-b border-gray-200 flex items-center justify-between flex-shrink-0">
          ...
          <nav className="flex items-center gap-1 bg-gray-100 rounded-lg p-1">
            ...
            <button onClick={() => setView('jarvis')} className={`px-4 py-1.5 rounded-md text-all ${view === 'jarvis' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}>
              Jarvis
            </button>
          </nav>
